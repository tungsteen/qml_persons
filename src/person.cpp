  ...
  : QObject(parent)
{
    ...
    setPhoneArea(json.value(QStringLiteral("phone_area")).toString());
    setPhoneNumber(json.value(QStringLiteral("phone_number")).toString());
    setFaxArea(json.value(QStringLiteral("fax_area")).toString());
    setFaxNumber(json.value(QStringLiteral("fax_number")).toString());
    setMobileArea(json.value(QStringLiteral("mobile_area")).toString());
    setMobileNumber(json.value(QStringLiteral("mobile_number")).toString());
    ...
    setBIC(json.value(QStringLiteral("bic")).toString());
